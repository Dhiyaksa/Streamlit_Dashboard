...
df = pd.read_csv('Proyek_Analisis_Data/Dashboard/Sharing_Bike_Clean.csv')
...
with col1:
   ...
   ##Membuat bar chart untuk melihat pengaruh Musim dan Cuaca terhadap Jumlah Penyewa Sepeda
   fig, ax = plt.subplots()
   sns.barplot(x='season', y='cnt', hue='weathersit', data=season_corr)
   plt.yscale('log')
   plt.legend(title='weathersit', loc='best', bbox_to_anchor=(1.05, 1), fontsize='small')
